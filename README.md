...
- **Електронна комерція** — повний цикл продажів: управління каталогом, розмірною сіткою та знижками. Стан кошика персистується без авторизації завдяки Zustand та localStorage, а транзакції безпечно обробляються платіжним шлюзом Stripe.

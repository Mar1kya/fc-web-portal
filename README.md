...
- **Контент та медіа** — новини, інтерв'ю, фотогалереї з прив'язкою до матчів та гравців
- **Команда** — профілі гравців і тренерів із гібридною статистикою (архівні дані + поточний сезон)
- **Матч-центр** — розклад, протоколи матчів, турнірні таблиці з автосинхронізацією Sofascore
- **Фаншоп** — каталог із фільтрами, кошик, Stripe-оплата, контекстні продажі через профілі гравців
- **Адміністративна панель** — повне керування контентом, замовленнями та синхронізацією

...
<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/home.png" alt="Головна сторінка порталу" /></td>
    <td width="50%"><img src="docs/screenshots/news.png" alt="Стрічка новин" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Головна сторінка</sub></td>
    <td align="center"><sub>Новини</sub></td>
  </tr>
  <tr>
    <td width="50%"><img src="docs/screenshots/gallery.png" alt="Фотогалерея" /></td>
    <td width="50%"><img src="docs/screenshots/team.png" alt="Профіль гравця" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Фотогалерея</sub></td>
    <td align="center"><sub>Команда – профіль гравця</sub></td>
  </tr>
  <tr>
    <td width="50%"><img src="docs/screenshots/match-center.png" alt="Детальний протокол матчу" /></td>
    <td width="50%"><img src="docs/screenshots/standings.png" alt="Турнірна таблиця" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Матч-центр – протокол матчу</sub></td>
    <td align="center"><sub>Турнірна таблиця</sub></td>
  </tr>
  <tr>
    <td width="50%"><img src="docs/screenshots/shop-catalog.png" alt="Каталог фаншопу" /></td>
    <td width="50%"><img src="docs/screenshots/product-detail.png" alt="Сторінка товару з розмірною сіткою" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Фаншоп – каталог</sub></td>
    <td align="center"><sub>Фаншоп – сторінка товару</sub></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><img src="docs/screenshots/checkout-flow.gif" alt="Кошик, оформлення замовлення та прив'язка гостьового замовлення" /></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><sub>Кошик (Zustand + persist) → гостьовий чекаут → прив'язка замовлення до акаунту</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="docs/screenshots/admin-dashboard.png" alt="Адмін-дашборд з KPI та графіками" /></td>
    <td width="50%"><img src="docs/screenshots/admin-sync.gif" alt="Синхронізація матчів із Sofascore" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Дашборд – KPI та аналітика продажів</sub></td>
    <td align="center"><sub>Синхронізація з Sofascore одним кліком</sub></td>
  </tr>
</table>
...
- **Оформлення замовлення** – покупка доступна як з акаунтом, так і без реєстрації (гостьовий чекаут).
  - Доступ до гостьового замовлення надається через підписаний токен, унікальний для конкретного замовлення, доданий до посилання, на яке гостя перенаправляє після оформлення. Саму сторінку замовлення може відкрити будь-хто, хто має посилання (особисті дані показуються замаскованими), а токен розблоковує повні, немасковані дані та дії з керування замовленням (наприклад, скасування) для того, хто ним володіє.
  - Якщо гість пізніше реєструється через Google OAuth, його попередні гостьові замовлення автоматично прив'язуються до нового акаунту (за збігом email).
  - Якщо користувач натомість реєструється через email/пароль, він може прив'язати свої гостьові замовлення вручну в особистому кабінеті, ввівши номер телефону замовлення та його 6-значний ідентифікатор.
...
# Доступ до гостьових замовлень
GUEST_ORDER_TOKEN_SECRET=            # Секрет для підпису токенів доступу до гостьових замовлень (згенерувати: openssl rand -hex 32)
```

...
export default function GlobalNotFound() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center py-24 px-4 text-center min-h-[60vh] md:min-h-[75vh]">
            <div className="relative mb-8">
                ...
                <div className="relative bg-card w-24 h-24 rounded-2xl flex items-center justify-center border border-border/50 shadow-sm">
                    <SearchX className="w-12 h-12 text-emerald-600" strokeWidth={1.5} />
                </div>
            </div>
            <H1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 text-foreground leading-tight">
                {t("title")}
            </H1>
            <p className="text-muted-foreground max-w-md mx-auto mb-10 text-base md:text-lg leading-relaxed text-balance">
                {t("description")}
            </p>

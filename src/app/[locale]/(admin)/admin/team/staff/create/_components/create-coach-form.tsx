...
import { BoundCoachData, createCoach } from "@/actions/team"
...
export function CreateCoachForm() {
    ...
    const [roleUk, setRoleUk] = useState("");
    ...
    const createCoachWithData = createCoach.bind(null, boundData);
    const [state, actionFn, isPending] = useActionState(createCoachWithData, undefined);

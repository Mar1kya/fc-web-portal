...
export function TournamentActions({ tournament }: { tournament: TournamentWithRelations }) {
    ...
    const handleArchive = () => {
        startTransition(async () => {
            const result = await softDeleteTournament(tournament.id);
            if (result?.success) {
        ...
        <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem asChild className="cursor-pointer">
                        <Link href={`/admin/tournaments/competitions/${tournament.id}/edit`}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Ви збираєтеся перемістити турнір <strong>&quot;{name}&quot;</strong> в архів.

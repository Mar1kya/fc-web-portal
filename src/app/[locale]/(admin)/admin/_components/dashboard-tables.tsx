    ...
    return (
        <div className="grid gap-4 grid-cols-1 lg:grid-cols-7">
            <CollapsibleCard
                ...
                description="Останні 10 транзакцій фаншопу."
                action={
                    <Button variant="outline" size="sm" asChild>
                        <Link href="/admin/shop/orders">Всі замовлення</Link>
                    </Button>
                }
                className="col-span-1 lg:col-span-4 flex flex-col min-w-0 overflow-hidden"
            >
            ...
            <div className="col-span-1 lg:col-span-3 flex flex-col gap-4 min-w-0">
                <CollapsibleCard
                    id="low-stock"
                    title={<span className="text-red-500">Залишки на складі</span>}
                    description="Товари, яких залишилося менше 5 шт."
                    action={<Badge variant="destructive" className="rounded-full">{lowStock.length}</Badge>}
                ...
                <CollapsibleCard
                    id="unsynced-matches"
                    title={<span className="text-amber-500">Очікують статистики</span>}
                    description="Зіграні матчі без подій та складів."
                >
                    <div className="space-y-4">

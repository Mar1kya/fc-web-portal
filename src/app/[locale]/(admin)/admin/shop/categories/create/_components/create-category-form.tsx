...
import { BoundCategoryData, createCategory } from "@/actions/category"
...
export function CreateCategoryForm() {
    ...
    const createCategoryWithData = createCategory.bind(null, boundData);
    const [state, actionFn, isPending] = useActionState(createCategoryWithData, undefined);

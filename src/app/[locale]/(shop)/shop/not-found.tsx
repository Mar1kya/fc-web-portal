...
export default function ShopNotFound() {
    const t = useTranslations("Shop.NotFound");
        ...
        <div className="w-full flex flex-col items-center justify-center py-24 px-4 text-center min-h-[60vh]">
            <div className="relative mb-8">
                ...
                <div className="relative bg-card w-24 h-24 rounded-2xl flex items-center justify-center border border-border/50 shadow-sm">
                    <ShoppingBag className="w-12 h-12 text-emerald-600 opacity-80" strokeWidth={1.5} />
                </div>
            </div>
            ...
            <Button asChild className="font-semibold" size="lg">
                <Link href="/shop" className="inline-flex items-center uppercase tracking-wider">
                    {t("backButton")}
                </Link>
            </Button>
        </div>
